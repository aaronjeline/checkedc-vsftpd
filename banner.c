...
void
vsf_banner_dir_changed(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), int ftpcode)
{
...
void
vsf_banner_write(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), struct mystr *p_str : itype(_Ptr<struct mystr>), int ftpcode)
{
