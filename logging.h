 ...
 */
void vsf_log_init(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
void vsf_log_line(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), enum EVSFLogEntryType what, struct mystr *p_str : itype(_Ptr<struct mystr>));
