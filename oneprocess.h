 ...
 */
void vsf_one_process_login(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), const struct mystr *p_pass_str : itype(_Ptr<const struct mystr>));
 ...
 * p_sess       - the current session object
 */
void vsf_one_process_pasv_cleanup(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
int vsf_one_process_pasv_active(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
unsigned short vsf_one_process_listen(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
