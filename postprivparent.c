...
static void minimize_privilege(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void process_post_login_req(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void cmd_process_chown(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void cmd_process_get_data_sock(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void cmd_process_pasv_cleanup(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void cmd_process_pasv_active(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void cmd_process_pasv_listen(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void cmd_process_pasv_accept(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
...
static void
process_post_login_req(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
  char cmd;
  /* Blocks */
...
static void
minimize_privilege(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
cmd_process_chown(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
cmd_process_get_data_sock(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
cmd_process_pasv_cleanup(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
cmd_process_pasv_active(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
cmd_process_pasv_listen(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
cmd_process_pasv_accept(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
