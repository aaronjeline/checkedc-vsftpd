...
static void parse_username_password(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void handle_user_command(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void handle_pass_command(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void handle_get(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void check_login_delay(void);
static void check_login_fails(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));

void
init_connection(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
parse_username_password(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
  while (1)
  {
...
static void
handle_get(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
  p_sess->is_http = 1;
...
static void
handle_user_command(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
handle_pass_command(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
