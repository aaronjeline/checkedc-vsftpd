 ...
 */
int vsf_privop_get_ftp_port_sock(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), unsigned short remote_port, int use_port_sockaddr);
 ...
 * p_sess       - the current session object
 */
void vsf_privop_pasv_cleanup(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
unsigned short vsf_privop_pasv_listen(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
int vsf_privop_pasv_active(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
int vsf_privop_accept_pasv(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
void vsf_privop_do_file_chown(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), int fd);
 ...
 */
enum EVSFPrivopLoginResult vsf_privop_do_login(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), const struct mystr *p_pass_str : itype(_Ptr<const struct mystr>));
