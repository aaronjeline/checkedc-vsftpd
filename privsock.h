 ...
 */
void priv_sock_send_str(int fd, const struct mystr *p_str : itype(_Ptr<const struct mystr>));
 ...
 */
void priv_sock_send_buf(int fd, const char *p_buf : itype(_Array_ptr<const char>) byte_count(len), unsigned int len);
 ...
 * len          - length of the buffer
 */
void priv_sock_recv_buf(int fd, char *p_buf : itype(_Array_ptr<char>) byte_count(len), unsigned int len);
 ...
 */
void priv_sock_get_str(int fd, struct mystr *p_dest : itype(_Ptr<struct mystr>));
