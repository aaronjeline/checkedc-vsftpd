...
typedef _Ptr<int (_Ptr<struct pt_sandbox>, void*)> ptrace_sandbox_validator_t;
 ...
 */
void ptrace_sandbox_free(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
 ...
 */
int ptrace_sandbox_launch_process(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), void (*)(void *) p_func : itype(_Ptr<void (void *)>), void* p_arg);
 ...
 */
int ptrace_sandbox_run_processes(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
 ...
 * p_sandbox        - the sandbox handle
 */
void ptrace_sandbox_kill_processes(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
 ...
 */
int ptrace_sandbox_get_arg(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), int arg, unsigned long *p_out : itype(_Ptr<unsigned long>));
 ...
 * 0 on success; otherwise it's a failure.
 */
int ptrace_sandbox_get_socketcall_arg(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), int arg, unsigned long *p_out : itype(_Ptr<unsigned long>));
 ...
 * 0 on success; otherwise it's a failure.
 */
int ptrace_sandbox_get_long(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), unsigned long ptr, unsigned long *p_out : itype(_Ptr<unsigned long>));
...
void ptrace_sandbox_permit_exit(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits read() */
void ptrace_sandbox_permit_read(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits write() */
void ptrace_sandbox_permit_write(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits sigaction() and rt_sigaction() */
void ptrace_sandbox_permit_sigaction(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits alarm() */
void ptrace_sandbox_permit_alarm(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits time() and gettimeofday() */
void ptrace_sandbox_permit_query_time(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits mmap2() (but not the MAP_SHARED flag) */
void ptrace_sandbox_permit_mmap(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits mprotect() */
void ptrace_sandbox_permit_mprotect(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits stat(), stat64(), lstat(), lstat64() */
void ptrace_sandbox_permit_file_stats(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits fstat(), fstat64() */
void ptrace_sandbox_permit_fd_stats(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits getcwd() */
void ptrace_sandbox_permit_getcwd(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits chdir() */
void ptrace_sandbox_permit_chdir(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits umask() */
void ptrace_sandbox_permit_umask(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits open(), except O_ASYNC and O_DIRECT. Only O_RDONLY
 * allowed unless writeable is 1
 */
void ptrace_sandbox_permit_open(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), int writeable);
/* POLICY EDIT: permits close() */
void ptrace_sandbox_permit_close(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits getdents(), getdents64() */
void ptrace_sandbox_permit_getdents(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
 ...
 */
void ptrace_sandbox_permit_fcntl(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits sendfile(), sendfile64() */
void ptrace_sandbox_permit_sendfile(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits lseek(), llseek() */
void ptrace_sandbox_permit_seek(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits select(), newselect() */
void ptrace_sandbox_permit_select(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits unlink() */
void ptrace_sandbox_permit_unlink(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits mkdir() */
void ptrace_sandbox_permit_mkdir(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits rmdir() */
void ptrace_sandbox_permit_rmdir(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits rename() */
void ptrace_sandbox_permit_rename(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits utime(), utimes() */
void ptrace_sandbox_permit_utime(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits sigreturn() */
void ptrace_sandbox_permit_sigreturn(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits recv() */
void ptrace_sandbox_permit_recv(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits readlink() */
void ptrace_sandbox_permit_readlink(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits brk() */
void ptrace_sandbox_permit_brk(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits nanosleep() */
void ptrace_sandbox_permit_sleep(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits fchmod() */
void ptrace_sandbox_permit_fchmod(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits chmod() */
void ptrace_sandbox_permit_chmod(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits fchown(), fchown32() */
void ptrace_sandbox_permit_fchown(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits mremap() */
void ptrace_sandbox_permit_mremap(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
/* POLICY EDIT: permits ftruncate(), ftruncate64() */
void ptrace_sandbox_permit_ftruncate(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
...
void ptrace_sandbox_set_socket_validator(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), ptrace_sandbox_validator_t val : itype(ptrace_sandbox_validator_t ), void* p_arg);
...
void ptrace_sandbox_set_bind_validator(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), ptrace_sandbox_validator_t val : itype(ptrace_sandbox_validator_t ), void* p_arg);
...
void ptrace_sandbox_set_connect_validator(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), ptrace_sandbox_validator_t val : itype(ptrace_sandbox_validator_t ), void* p_arg);
...
void ptrace_sandbox_permit_accept(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>));
...
void ptrace_sandbox_set_setsockopt_validator(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), ptrace_sandbox_validator_t val : itype(ptrace_sandbox_validator_t ), void* p_arg);
...
void ptrace_sandbox_set_getsockopt_validator(struct pt_sandbox *p_sandbox : itype(_Ptr<struct pt_sandbox>), ptrace_sandbox_validator_t val : itype(ptrace_sandbox_validator_t ), void* p_arg);
