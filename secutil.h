...
void vsf_secutil_change_credentials(const struct mystr *p_user_str : itype(_Ptr<const struct mystr>), const struct mystr *p_dir_str : itype(_Ptr<const struct mystr>), const struct mystr *p_ext_dir_str : itype(_Ptr<const struct mystr>), unsigned int caps, unsigned int options);
#endif /* VSF_SECUTIL_H */
