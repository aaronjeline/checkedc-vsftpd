...
void vsf_sysutil_getsockname(int fd, struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<struct vsf_sysutil_sockaddr *>));
void vsf_sysutil_getpeername(int fd, struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<struct vsf_sysutil_sockaddr *>));
...
void vsf_sysutil_dns_resolve(struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<struct vsf_sysutil_sockaddr *>), const char *p_name : itype(_Nt_array_ptr<const char>));
