...
int vsf_sysutil_open_file(const char *p_filename : itype(_Nt_array_ptr<const char>), const enum EVSFSysUtilOpenMode mode);
...
int vsf_sysutil_create_or_open_file_append(const char *p_filename : itype(_Nt_array_ptr<const char>), unsigned int mode);
/* Creates or appends */
...
int vsf_sysutil_write_access(const char *p_filename : itype(_Nt_array_ptr<const char>) count(1));
...
void vsf_sysutil_dir_stat(const struct vsf_sysutil_dir *p_dir : itype(_Ptr<const struct vsf_sysutil_dir>), struct vsf_sysutil_statbuf **p_ptr : itype(_Ptr<_Ptr<struct vsf_sysutil_statbuf>>));
...
const char *vsf_sysutil_statbuf_get_perms(const struct vsf_sysutil_statbuf* p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>)) : itype(_Nt_array_ptr<const char>); 
const char *vsf_sysutil_statbuf_get_date(const struct vsf_sysutil_statbuf* p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>), int use_localtime, long curr_time) : itype(_Nt_array_ptr<const char>);
const char *vsf_sysutil_statbuf_get_numeric_date(const struct vsf_sysutil_statbuf *p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>), int use_localtime) : itype(_Nt_array_ptr<const char>);
...
int vsf_sysutil_statbuf_is_readable_other(const struct vsf_sysutil_statbuf *p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>));
const char *vsf_sysutil_statbuf_get_sortkey_mtime(const struct vsf_sysutil_statbuf* p_stat : itype(_Ptr<const struct vsf_sysutil_statbuf>)) : itype(_Nt_array_ptr<const char>);
...
int vsf_sysutil_readlink(const char *p_filename : itype(_Nt_array_ptr<const char>), char *p_dest : itype(_Nt_array_ptr<char>) count(bufsiz), unsigned int bufsiz);
...
int vsf_sysutil_wait_get_retval(const struct vsf_sysutil_wait_retval *p_waitret : itype(_Ptr<const struct vsf_sysutil_wait_retval>));
int vsf_sysutil_wait_exited_normally(const struct vsf_sysutil_wait_retval *p_waitret : itype(_Ptr<const struct vsf_sysutil_wait_retval>));
int vsf_sysutil_wait_get_exitcode(const struct vsf_sysutil_wait_retval *p_waitret : itype(_Ptr<const struct vsf_sysutil_wait_retval>));
...
char *vsf_sysutil_strndup(const char *p_str : itype(_Array_ptr<const char>) count(p_len), unsigned int p_len) : itype(_Nt_array_ptr<char>) count(p_len);
...
void vsf_sysutil_strcpy(char *p_dest : itype(_Array_ptr<char>) count(maxsize), const char *p_src : itype(_Array_ptr<const char>) count(maxsize), unsigned int maxsize);
...
unsigned int vsf_sysutil_octal_to_uint(const char *p_str : itype(_Nt_array_ptr<const char>));
...
void vsf_sysutil_sockaddr_clear(struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<_Ptr<struct vsf_sysutil_sockaddr>>));
void vsf_sysutil_sockaddr_alloc_ipv4(struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<_Ptr<struct vsf_sysutil_sockaddr>>));
void vsf_sysutil_sockaddr_alloc_ipv6(struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<_Ptr<struct vsf_sysutil_sockaddr>>));
...
void* vsf_sysutil_sockaddr_get_raw_addr(struct vsf_sysutil_sockaddr *p_sockptr : itype(_Ptr<struct vsf_sysutil_sockaddr>)) : itype(_Array_ptr<void>) byte_count(sizeof(p_sockptr->u.u_sockaddr_in6.sin6_addr));
const void* vsf_sysutil_sockaddr_ipv6_v4(const struct vsf_sysutil_sockaddr *p_addr : itype(_Ptr<const struct vsf_sysutil_sockaddr>)) : itype(_Array_ptr<const void>) byte_count(4);
const void* vsf_sysutil_sockaddr_ipv4_v6(const struct vsf_sysutil_sockaddr *p_sockaddr : itype(_Ptr<const struct vsf_sysutil_sockaddr>)) : itype(_Array_ptr<const void>) byte_count(16);
...
void vsf_sysutil_getsockname(int fd, struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<_Ptr<struct vsf_sysutil_sockaddr>>));
void vsf_sysutil_getpeername(int fd, struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<_Ptr<struct vsf_sysutil_sockaddr>>));
int vsf_sysutil_accept_timeout(int fd, struct vsf_sysutil_sockaddr *p_sockaddr : itype(_Ptr<struct vsf_sysutil_sockaddr>), unsigned int wait_seconds);
int vsf_sysutil_connect_timeout(int fd, const struct vsf_sysutil_sockaddr *p_sockaddr : itype(_Ptr<const struct vsf_sysutil_sockaddr>), unsigned int wait_seconds);
void vsf_sysutil_dns_resolve(struct vsf_sysutil_sockaddr **p_sockptr : itype(_Ptr<_Ptr<struct vsf_sysutil_sockaddr>>), const char *p_name : itype(_Nt_array_ptr<const char>));
...
const char *vsf_sysutil_user_get_homedir(const struct vsf_sysutil_user *p_user : itype(_Ptr<const struct vsf_sysutil_user>)) : itype(_Nt_array_ptr<const char>);
...
_Itype_for_any(T) void vsf_sysutil_qsort(void* p_base : itype(_Array_ptr<T>) byte_count(num_elem * elem_size), unsigned int num_elem, unsigned int elem_size, int ((*p_compar)(const void *, const void *)) : itype(_Ptr<int (_Ptr<const T>, _Ptr<const T>)>));
...
void vsf_sysutil_syslog(const char *p_text : itype(_Nt_array_ptr<const char>), int severe);
...
void vsf_sysutil_chroot(const char *p_root_path : itype(_Nt_array_ptr<const char>) count(1));
...
long vsf_sysutil_parse_time(const char *p_text : itype(_Nt_array_ptr<const char>) count(14));
