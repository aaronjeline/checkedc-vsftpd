...
/* String defines */
extern const char* tunable_secure_chroot_dir : itype(_Nt_array_ptr<const char>);
extern const char* tunable_ftp_username : itype(_Nt_array_ptr<const char>);
extern const char* tunable_chown_username : itype(_Nt_array_ptr<const char>);
extern const char* tunable_xferlog_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_vsftpd_log_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_message_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_nopriv_user : itype(_Nt_array_ptr<const char>);
extern const char* tunable_ftpd_banner : itype(_Nt_array_ptr<const char>);
extern const char* tunable_banned_email_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_chroot_list_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_pam_service_name : itype(_Nt_array_ptr<const char>);
extern const char* tunable_guest_username : itype(_Nt_array_ptr<const char>);
extern const char* tunable_userlist_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_anon_root : itype(_Nt_array_ptr<const char>);
extern const char* tunable_local_root : itype(_Nt_array_ptr<const char>);
extern const char* tunable_banner_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_pasv_address : itype(_Nt_array_ptr<const char>);
extern const char* tunable_listen_address : itype(_Nt_array_ptr<const char>);
extern const char* tunable_user_config_dir : itype(_Nt_array_ptr<const char>);
extern const char* tunable_listen_address6 : itype(_Nt_array_ptr<const char>);
extern const char* tunable_cmds_allowed : itype(_Nt_array_ptr<const char>);
extern const char* tunable_hide_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_deny_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_upload_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_download_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_user_sub_token : itype(_Nt_array_ptr<const char>);
extern const char* tunable_email_password_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_rsa_cert_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_dsa_cert_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_ssl_ciphers : itype(_Nt_array_ptr<const char>);
extern const char* tunable_rsa_private_key_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_dsa_private_key_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_ca_certs_file : itype(_Nt_array_ptr<const char>);
extern const char* tunable_cmds_denied : itype(_Nt_array_ptr<const char>);
