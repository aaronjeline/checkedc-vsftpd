...
static void process_login_req(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
static void common_do_login(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), const struct mystr *p_user_str : itype(_Ptr<const struct mystr>), int do_chroot, int anon);
static void handle_per_user_config(const struct mystr *p_user_str : itype(_Ptr<const struct mystr>));
static void calculate_chdir_dir(int anon, struct mystr *p_userdir_str : itype(_Ptr<struct mystr>), struct mystr *p_chroot_str : itype(_Ptr<struct mystr>), struct mystr *p_chdir_str : itype(_Ptr<struct mystr>), const struct mystr *p_user_str : itype(_Ptr<const struct mystr>), const struct mystr *p_orig_user_str : itype(_Ptr<const struct mystr>));
...
void
vsf_two_process_start(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
void
vsf_two_process_login(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), const struct mystr *p_pass_str : itype(_Ptr<const struct mystr>))
{
  char result;
...
void
vsf_two_process_pasv_cleanup(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
  char res;
...
int
vsf_two_process_pasv_active(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
unsigned short
vsf_two_process_listen(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
process_login_req(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>))
{
...
static void
common_do_login(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), const struct mystr *p_user_str : itype(_Ptr<const struct mystr>), int do_chroot, int anon)
{
  int was_anon = anon;
...
static void
handle_per_user_config(const struct mystr *p_user_str : itype(_Ptr<const struct mystr>))
{
...
static void
calculate_chdir_dir(int anon_login, struct mystr *p_userdir_str : itype(_Ptr<struct mystr>), struct mystr *p_chroot_str : itype(_Ptr<struct mystr>), struct mystr *p_chdir_str : itype(_Ptr<struct mystr>), const struct mystr *p_user_str : itype(_Ptr<const struct mystr>), const struct mystr *p_orig_user_str : itype(_Ptr<const struct mystr>))
{
  if (!anon_login)
  {
