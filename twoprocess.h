 ...
 */
void vsf_two_process_start(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
void vsf_two_process_login(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>), const struct mystr *p_pass_str : itype(_Ptr<const struct mystr>));
 ...
 * p_sess       - the current session object
 */
void vsf_two_process_pasv_cleanup(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
int vsf_two_process_pasv_active(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
 ...
 */
unsigned short vsf_two_process_listen(struct vsf_session *p_sess : itype(_Ptr<struct vsf_session>));
