 ...
 */
void die(const char *p_text : itype(_Nt_array_ptr<const char>));
 ...
 */
void die2(const char *p_text1 : itype(_Nt_array_ptr<const char>), const char *p_text2 : itype(_Nt_array_ptr<const char>));
 ...
 *       */
void bug(const char *p_text : itype(_Nt_array_ptr<const char>));
 ...
 * p_text       - text string describing why the process is exiting
 */
void vsf_exit(const char *p_text : itype(_Nt_array_ptr<const char>));
